...
# IMAGES
img_icon = pygame.image.load('Labs/Lab8/Racer/images/coin/1.png') # Logo

pygame.display.set_icon(img_icon)

img_road = pygame.image.load('Labs/Lab8/Racer/images/road.png') # Background (Road)
img_player = pygame.image.load('Labs/Lab8/Racer/images/car1.png') # Player
img_coin = pygame.image.load('Labs/Lab8/Racer/images/coin/1.png') # Coin
img_enemy = pygame.image.load('Labs/Lab8/Racer/images/enemycar.png')  # Enemy

# SOUNDS
sound_crash = pygame.mixer.Sound('Labs/Lab8/Racer/sounds/crash.mp3')
sound_crash.set_volume(0.1)

sound_coin = pygame.mixer.Sound('Labs/Lab8/Racer/sounds/coin.mp3')
sound_coin.set_volume(0.05)

sound_bg = pygame.mixer.Sound('Labs/Lab8/Racer/sounds/bg.mp3')
...
while running:
    ...
    if not game_over:
        ...
        # Display Score
        font_score = pygame.font.Font("Labs/Lab8/Racer/fonts/VT323-Regular.ttf", 36)
