...
while running:
    ...
    # Отображение экрана паузы
            ...
            text_pause = font_pause.render("PAUSED - Press Q to Resume", True, colorWHITE)
            screen.blit(text_pause, text_pause.get_rect(center=(WIDTH // 2, HEIGHT // 2)))
            pygame.display.flip()
            clock.tick(5)
            continue
